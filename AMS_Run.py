    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='khushbu', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/hp/Project/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/' + DB_table_name + '.csv'
                ...
                def attf():
                 import subprocess
                 subprocess.Popen(
                    r'explorer /select,"C:/Users/hp/Project/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier("C:\\Users\\hp\\Project\\Face-Recognition-Attendance-System-main\\haarcascade_frontalface_default.xml")
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("C:/Users/hp/Project/Face-Recognition-Attendance-System-main/TrainingImage " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg", gray)
            ...
            with open('C:\\Users\\hp\\Project\\Face-Recognition-Attendance-System-main\\StudentDetails\\StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                   recognizer.read("C:/Users/hp/Project/Face-Recognition-Attendance-System-main/TrainingImageLabel/Trainner.yml")
                ...
                harcascadePath = "C:/Users/hp/Project/Face-Recognition-Attendance-System-main/haarcascade_frontalface_default.xml"

                

                # Load the cascade classifier
                face_cascade = cv2.CascadeClassifier('C:/Users/hp/Project/Face-Recognition-Attendance-System-main/haarcascade_frontalface_default.xml')


                df = pd.read_csv("C:/Users/hp/Project/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv")
                ...
                timeStamp = datetime.datetime.fromtimestamp(
                    ts).strftime('%H:%M:%S')
                Hour, Minute, Second = timeStamp.split(":")
                fileName = "C:/Users/hp/Project/Face-Recognition-Attendance-System-main/Attendance" + Subject + "_" + date + \
           "_" + Hour + "-" + Minute + "-" + Second + ".csv"
                ...
                root.configure(background='grey80')
                cs = os.path.join('C:/Users/hp/Project/Face-Recognition-Attendance-System-main', fileName)
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/hp/Project/Face-Recognition-Attendance-System-main/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'khushbu':
            if password == 'khushbu123':
                ...
                cs = 'C:/Users/hp/Project/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    try:
       faces, Id = getImagesAndLabels("C:/Users/hp/Project/Face-Recognition-Attendance-System-main/TrainingImage")
    ...
    try:
       recognizer.save("C:\\Users\\hp\\Project\\Face-Recognition-Attendance-System-main\\TrainingImageLabel\\Trainner.yml")
...
FA.place(x=530, y=500)

manuallyFillButton = tk.Button(window, text="Manually Fill Attendance", command=manually_fill, fg="black",
                                bg="SkyBlue1", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
manuallyFillButton.place(x=790, y=500)

quitWindow = tk.Button(window, text="Exit", fg="black", command=window.destroy, bg="SkyBlue1",
                       width=20, height=3, activebackground="Red", font=('times', 15, ' bold '))
quitWindow.place(x=1050, y=500)  # Adjusted y-coordinate for proper spacing
